        ...
        for img in os.listdir(person_path):
            ...
            try:
                ...
                for i in range(N_AUG):
                    ...
                    # Save temporarily
                    temp_path = save_temp_image(aug_img_bgr, f"temp_aug_{person}_{i}.jpg")

                    # Generate embedding for augmented image
                    aug_rep = DeepFace.represent(img_path=temp_path, model_name="ArcFace", enforce_detection=False)
